...
The Data Specification on Environmental Monitoring Facilities – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Environmental Monitoring Facilities.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Environmental Monitoring Facilities](http://inspire.ec.europa.eu/id/ats/data-ef/3.0/ef-gml) | INSPIRE spatial data set encoded in GML, Environmental Monitoring Facilities features |
| [Application Schema, Environmental Monitoring Facilities](http://inspire.ec.europa.eu/id/ats/data-ef/3.0/ef-as) | INSPIRE spatial data set |
| [Reference Systems, Environmental Monitoring Facilities](http://inspire.ec.europa.eu/id/ats/data-ef/3.0/ef-rs) | INSPIRE spatial data set |
| [Data Consistency, Environmental Monitoring Facilities](http://inspire.ec.europa.eu/id/ats/data-ef/3.0/ef-dc) | INSPIRE spatial data set |
| [Information Accessibility, Environmental Monitoring Facilities](http://inspire.ec.europa.eu/id/ats/data-ef/3.0/ef-ia) | INSPIRE spatial data set |
| [Portrayal, Environmental Monitoring Facilities](http://inspire.ec.europa.eu/id/ats/data-ef/3.0/ef-portrayal) | INSPIRE view service |

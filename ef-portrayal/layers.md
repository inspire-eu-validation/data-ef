...
* Verify for each layer that title of the layer is the one specified in the column "Layer title" in sub-clamse 11.1 or one of the translations in section 8.8 in Annex II of the regulation ([IP IOP](./README.md#ref_IR_IOP), [IP IOP Amd 2](./README.md#ref_IR_IOP_EFd2)). 
...
* [TG DS-EF](./README.md#ref_TG_DS_EF), IR Requirement, Article 14
* [TG DS-EF](./README.md#ref_TG_DS_EF), TG Requirement 7

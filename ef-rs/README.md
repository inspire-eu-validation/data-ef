# Conformance class: Reference systems, Environmental Monitoring Facilities
...
| ------------- | ----------------- | ---------------- | ---------- |
| [TG DS-EF](#ref_TG_DS_EF) | [GML application schema, Environmental Monitoring Facilities](../ef-gml/README.md) | INSPIRE spatial data set encoded in GML, Environmental Monitoring Facilities features | n/a |
...
-------------------------------- | --------------------------------------------------
TG DS-EF <a name="ref_TG_DS_EF"></a>   | [INSPIRE Data Specification on Environmental Monitoring Facilities – Technical Guidelines version 3.2](http://inspire.ec.europa.eu/documents/Data_Specifications/INSPIRE_DataSpecification_EF_v3.0.pdf)

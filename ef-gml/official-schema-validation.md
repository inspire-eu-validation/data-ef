...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/ef/4.0/EnvironmentalMonitoringFacilities.xsd, using strict XML schema validation.
